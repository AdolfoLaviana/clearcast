...
const WasmAudioEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmaudioengine_free(ptr >>> 0, 1));
/**
...
export class WasmAudioEngine {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmAudioEngine.prototype);
        obj.__wbg_ptr = ptr;
        WasmAudioEngineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmAudioEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmaudioengine_free(ptr, 0);
    }
    /**
     * Create a new audio engine with default settings
     */
    constructor() {
        const ret = wasm.wasmaudioengine_new();
        this.__wbg_ptr = ret >>> 0;
        WasmAudioEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('clearcast_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
